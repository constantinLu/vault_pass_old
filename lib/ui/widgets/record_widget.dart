...
import 'package:vault_pass/util/device_size.dart';
...
class RecordWidget extends StatelessWidget {
  ...
  void selectView(RecordType recordType, BuildContext context) {
    switch (recordType) {
      ...
      case RecordType.work_account:
        AppRouter.to(context, RouteName.ACCOUNT_VIEW);
        break;
      //same page
      case RecordType.address:

        AppRouter.to(context, RouteName.ADDRESS_VIEW);
        break;
    }
  }
                    ...
                    children: [
                      Expanded(
                        // Gradient rounded - square - record name
                          flex: 3, child: RecordNameWidget(record.recordName, textBackgroundColor)),
