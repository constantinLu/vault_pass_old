...
import 'package:vault_pass/application/auth/auth_bloc.dart' as _i15;
import 'package:vault_pass/application/login/login_bloc.dart' as _i13;
import 'package:vault_pass/application/register/register_bloc.dart' as _i14;
import 'package:vault_pass/domain/auth/auth_facade.dart' as _i11;
import 'package:vault_pass/infra/database/vaultdb.dart' as _i10;
import 'package:vault_pass/infra/module/vaultpass_module.dart' as _i16;
...
import 'package:vault_pass/infra/service/auth_facade.dart' as _i12;
import 'package:vault_pass/infra/service/biometrics_service.dart' as _i4;
import 'package:vault_pass/infra/service/secure_storage_service.dart' as _i7;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i10.VaultPassDb>(() => _i10.VaultPassDb());
    gh.lazySingleton<_i11.IAuthFacade>(
        () => _i12.AuthFacade(gh<_i9.UserService>()));
    gh.factory<_i13.LoginBloc>(() => _i13.LoginBloc(gh<_i11.IAuthFacade>()));
    gh.factory<_i14.RegisterBloc>(
        () => _i14.RegisterBloc(gh<_i11.IAuthFacade>()));
    gh.factory<_i15.AuthBloc>(() => _i15.AuthBloc(gh<_i11.IAuthFacade>()));
    return this;
  }
}
